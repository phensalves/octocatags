...
class GithubUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create github_user" do
    assert_difference('GithubUser.count') do
      post github_users_url, params: { github_user: { github_id: @github_user.github_id, login: @github_user.login } }
    end
  ...
  test "should update github_user" do
    patch github_user_url(@github_user), params: { github_user: { github_id: @github_user.github_id, login: @github_user.login } }
